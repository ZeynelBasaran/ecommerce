        ...
        <div className="gap-3 pb-6 sm:flex sm:items-start">
          <div className="shrink-0 space-y-2 sm:w-48 md:w-72 ">
            ...
            <div className="space-y-0.5">
              <p className="text-base font-semibold text-gray-900 dark:text-white">{reviewerName}</p>
          ...
          <div className="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0 ">
            <p className="text-base font-normal text-gray-500 dark:text-gray-400">{comment}</p>
          </div>
        </div>
      </div>
